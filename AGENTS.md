...
- Canonical repo target: `kotlin-dotenv-parser`. Useful entrypoints: `dev project show kotlin-dotenv-parser`, `dev build kotlin-dotenv-parser`, `dev check kotlin-dotenv-parser`.
- Setup-managed files are regenerated with `dev setup kotlin-dotenv-parser`; avoid hand-editing stamped generated files.

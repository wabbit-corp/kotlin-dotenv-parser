...
// managed-integrity-v1: 4knJ5WvczR7
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-dotenv-parser", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-dotenv-parser")
        description.set("kotlin-dotenv-parser")
        url.set("https://github.com/wabbit-corp/kotlin-dotenv-parser")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-dotenv-parser")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-dotenv-parser.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-dotenv-parser.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-dotenv-parser"
...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("one.wabbit:kotlin-parsing-charset:1.4.0")

                implementation("one.wabbit:kotlin-parsing-charinput:2.0.0")
